...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #BFC9C9, #0F3B3B);
        }
    </style>
...
st.markdown("""
    <div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: #FFFFFF;'>
      🤖 Welcome to the Electric Vehicle (EV) Adoption Forecast 🚗
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: left; font-size: 22px; padding-top: 10px; color: #FFFFFF;'>
        Select a county and see the forecasted EV adoption statistics for the next 3 years.
    </div>
""", unsafe_allow_html=True)
...
st.markdown("---")
st.header("Compare EV Adoption Statistics for up to 3 Counties")
...
st.markdown("Prepared By **Gangavarapu Sai Sugeet**")